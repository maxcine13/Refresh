...
import com.jierong.share.mvp.presenter.BzFxListPresenter;
import com.jierong.share.mvp.view.IBzFxView;
import com.jierong.share.mvp.view.ada.BzFxAdapter;
...
public class BzFxFrag extends BaseFrag implements IBzFxView, BaseQuickAdapter.
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_bz_fx, null);
        initView(view);
        return view;
    }
    ...
    private void initAdapter() {
        mBzFxAdapter = new BzFxAdapter(data);
        mBzFxAdapter.setOnLoadMoreListener(this, mRecyclerView);
        mBzFxAdapter.openLoadAnimation(BaseQuickAdapter.ALPHAIN);
        mRecyclerView.setAdapter(mBzFxAdapter);
    }
    ...
    private void addHeadView() {
        ...
        mBzFxAdapter.addHeaderView(headView);
    }

    private void initView(View view) {
        mBzFxListPresenter = new BzFxListPresenter(this);
    ...
    public void onRefresh() {
        mBzFxAdapter.setEnableLoadMore(false);
        mPageIndex = 1;
        isClosed = false;
        mBzFxListPresenter.loadData(true);
    }
    ...
    public void onLoadMoreRequested() {
        ...
        mBzFxListPresenter.loadData(false);
    }
    ...
    public void refreshSuccess(String sum, List<ShopInfo> data) {
        ...
        if(null == data) {
            ...
            mBzFxAdapter.getData().clear();
            mSwipeRefreshLayout.setRefreshing(false);
            mBzFxAdapter.setEnableLoadMore(true);
            return;
        }
    ...
    public void loadSuccess(String sum, List<ShopInfo> data) {
        ...
        isClosed = false;
        mBzFxAdapter.addData(data);
        mBzFxAdapter.loadMoreComplete();
    ...
    public void loadEnd() {
        isClosed = true;
        mBzFxAdapter.loadMoreEnd(false);
        mSwipeRefreshLayout.setEnabled(true);
    }
    ...
    public void showError(String msg, boolean flag, boolean isRefresh) {
        ...
        if(isRefresh) {
            ...
            if(mSwipeRefreshLayout.getVisibility() == View.VISIBLE)
                mSwipeRefreshLayout.setVisibility(View.GONE);
            mBzFxAdapter.getData().clear();
            mBzFxAdapter.notifyDataSetChanged();
            mSwipeRefreshLayout.setRefreshing(false);
            mBzFxAdapter.setEnableLoadMore(true);
        } else {
            LogUtil.e("加载加载失败");
            isClosed = true;
            mBzFxAdapter.loadMoreFail();
            mSwipeRefreshLayout.setEnabled(true);
        }
