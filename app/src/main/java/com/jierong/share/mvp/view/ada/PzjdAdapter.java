 ...
 * 品质家电数据适配器
 */
public class PzjdAdapter extends BaseQuickAdapter<TaoBaoInfo, BaseViewHolder> {

    public PzjdAdapter(List<TaoBaoInfo> data) {
        super(R.layout.item_pzjd_content, data);
    }
