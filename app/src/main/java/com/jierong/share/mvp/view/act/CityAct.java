 ...
 * 省、市、区选择界面
 */
public class CityAct extends Activity {
    ...
    private RelativeLayout city_rela;
    @Override
    ...
    private void updateArea(Object object, Object myArea) {
        ...
        if (area != null) {
            city_rela.setVisibility(View.VISIBLE);
            ...
            city_rela.setVisibility(View.GONE);
        }
    ...
    private void initClick() {
        btn_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(StringUtil.isNotEmptyIgnoreBlank(areaName)) {
                    intent.putExtra("address",
                            spinner_sheng.getSelectedItem()
                                    + "-" + spinner_shi.getSelectedItem()
                                    + "-" + areaName);
                } else {
                    intent.putExtra("address",
                            spinner_sheng.getSelectedItem()
    ...
    private void initView() {
        ((TextView) findViewById(R.id.titleName)).setText("请选择地区");
        ...
        city_rela = (RelativeLayout) findViewById(R.id.city_rela);
