 ...
 * 超值返利数据适配器
 */
public class CzflAdapter extends BaseQuickAdapter<TaoBaoInfo, BaseViewHolder> {

    public CzflAdapter(List<TaoBaoInfo> data) {
        super(R.layout.item_czfl_content, data);
    }
