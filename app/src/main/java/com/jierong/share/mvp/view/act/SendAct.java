 ...
 * 广告投放模块
 */
public class SendAct extends BindAct implements View.OnClickListener, ISendView {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frag_send);
        initView();
    }
    ...
    private void initView() {
        ...
        ((TextView) findViewById(R.id.titleName)).setText(R.string.bottom_name_send);
        ...
        view_nonet = (RelativeLayout) findViewById(R.id.view_nonet);
        send_name = (RelativeLayout) findViewById(R.id.send_name);
        send_tel = (RelativeLayout) findViewById(R.id.send_tel);
        send_type = (RelativeLayout) findViewById(R.id.send_type);
        send_desc = (RelativeLayout) findViewById(R.id.send_desc);
        send_tip = (TextView) findViewById(R.id.send_tip);
        value_name = (EditText) findViewById(R.id.value_name);
        value_tel = (EditText) findViewById(R.id.value_tel);
        value_desc = (TextView) findViewById(R.id.value_desc);
        send_submit = (TextView) findViewById(R.id.send_submit);
        value_typ = (TextView) findViewById(R.id.value_typ);
        value_type = (Spinner) findViewById(R.id.value_type);
        mSendPresenter.getSendType();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.value_typ:
                try {
                    if (data.size() > 0) {
                        typeDialog = new TypeDialog(SendAct.this, data);
                        ...
                        ToastUtils.show(SendAct.this, "暂无分类!");
                    }
                } catch (Exception e) {
    ...
    public void showLoading() {
        if (mLoadingDialog == null) {
            mLoadingDialog = LoadingDialog.createLoadingDialog(SendAct.this, "正在加载中...");
            mLoadingDialog.show();
        }
    }
    ...
    private void editDesc() {
        Intent intent = new Intent(SendAct.this, EditTextAct.class);
    ...
    public void sendSuccess() {
        ToastUtils.show(SendAct.this, "需求提交成功,工作人员将在24小时内完成审核!");
    ...
    public void showError(String msg, boolean flag) {
        ToastUtils.show(SendAct.this, msg);
        if (flag) SendAct.this.finish();
    }
