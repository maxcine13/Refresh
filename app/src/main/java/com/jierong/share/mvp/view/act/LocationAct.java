...
import com.jierong.share.location.adapter.CityListAdapter;
import com.jierong.share.location.adapter.SearchResultAdapter;
import com.jierong.share.location.bean.City;
import com.jierong.share.location.dbhelper.AllCitySqliteOpenHelper;
import com.jierong.share.location.dbhelper.CitySqliteOpenHelper;
import com.jierong.share.location.utils.PingYinUtil;
import com.jierong.share.location.view.MyLetterView;
...
public class LocationAct extends BaseAct {
    ...
    private void initView() {
        ...
        ((TextView) findViewById(R.id.titleName)).setText(R.string.title_name_city);
    ...
    private void setListener() {
         ...
         * 刚进入此页面时显示的列表点击事件
         */
        cityListAdapter.setOnCityclickListener(new CityListAdapter.onCityOnclickListener() {
            @Override
            public void onCityClick(int position, String cityList) {
                InsertCity(cityList);
                EventBusInfo eventBusInfo=new EventBusInfo();
                eventBusInfo.setName("LocationAct");
                eventBusInfo.setValue(cityList);
         ...
         * 搜索出来的城市点击事件
         */
        searchResultAdapter.setOnCityclickListener(new SearchResultAdapter.onCityOnclickListener() {
            @Override
            public void onCityClick(int position, String cityList) {
                InsertCity(cityList);
                EventBusInfo eventBusInfo=new EventBusInfo();
...
//					 延迟一秒后执行，让中间显示的TextView为不可见
    ...
    private void initData() {
        cityOpenHelper = new CitySqliteOpenHelper(LocationAct.this);
    ...
    private ArrayList<City> getCityList() {
        ...
        AllCitySqliteOpenHelper op = new AllCitySqliteOpenHelper(LocationAct.this);
