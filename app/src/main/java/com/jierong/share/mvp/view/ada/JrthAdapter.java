 ...
 * 今日特惠数据适配器
 */
public class JrthAdapter extends BaseQuickAdapter<TaoBaoInfo, BaseViewHolder> {

    public JrthAdapter(List<TaoBaoInfo> data) {
        super(R.layout.item_jrth_content, data);
    }
