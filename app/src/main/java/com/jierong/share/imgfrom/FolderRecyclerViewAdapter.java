...
public class FolderRecyclerViewAdapter extends RecyclerView.Adapter<FolderRecyclerViewAdapter.ViewHolder> {
    ...
    private final OnFolderListener mListener;
    private Context mContext;
    private final String TAG = "FolderAdapter";

    public FolderRecyclerViewAdapter(Context context, List<FolderItem> items, OnFolderListener listener) {
        mContext = context;
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        Glide.with(mContext)
                .load(Uri.fromFile(new File(folderItem.coverImagePath)))
