package com.jierong.share.location.dbhelper;
...
public class AllCitySqliteOpenHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/com.jierong.share/databases/";
	private static String DB_NAME = "share.db";
	private Context mContext;
	private static String ASSETS_NAME = "share.db";
