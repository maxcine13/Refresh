...
public class SimpleDia extends Dialog implements View.OnClickListener {
    ...
    private void restore() {
        ...
        mConfirmButton.setBackgroundResource(R.drawable.dialog_bt_selector_left);
    }
...
//    public SimpleDia setCustomImage (Drawable drawable) {
...
//	public SimpleDia setCustomImage (int resourceId) {
