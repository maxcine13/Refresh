...
public class TanTanCallback extends RenRenCallback {
    private static final int MAX_ROTATION = 10;     // 旋转、循环
    // 2016 12 26 考虑 探探垂直上下方向滑动，不删除卡片，
    // 判断 此次滑动方向是否是竖直的 ，水平方向上的误差(阈值，默认我给了35dp)
    ...
    public TanTanCallback(RecyclerView rv, RecyclerView.Adapter adapter, List datas) {
        ...
        mHorizontalDeviation = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                35, mRv.getContext().getResources().getDisplayMetrics());
    }
