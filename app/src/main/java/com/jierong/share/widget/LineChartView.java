        ...
        for (int i = 0; i < n; i++){
            ...
            switch (index)
            {
                ...
                case R.styleable.LineChartView_lineColor:
                    mLineColor = a.getColor(index, Color.GREEN);
                    break;
                // X轴每个刻度的间距间距
                case R.styleable.LineChartView_dividerCount:
                    dividerCount = a.getInt(index, 1);
                    Log.d(TAG, "dividerCount: "+dividerCount);
                    break;
                // X轴每个刻度的间距间距
...
//                    Log.d(TAG, "mxInterval: "+mxInterval);
                    WindowManager wm = (WindowManager) getContext()
                            .getSystemService(Context.WINDOW_SERVICE);
                    int width = wm.getDefaultDisplay().getWidth();
                    mxInterval = width/12;
                    Log.d(TAG, "mxInterval: "+mxInterval+":"+width);
                    break;
                // Y轴距离view长度
    ...
    private void init(Context context){
       ...
       // linePaint.setColor(mLineColor);
        ...
        innerCirclePaint.setColor(getResources().getColor(R.color.colorAccent));
        ...
        middleCiclePaint.setColor(getResources().getColor(R.color.colorAccent));
